			...
			<div id="dialog-form" title="학력 추가">
				...
				<form>
					<fieldset>
						...
						<input type="text" name="location" id="location" value="서울" class="text ui-widget-content ui-corner-all"><br>
						<label for="school">학 교</label><br>
						<input type="text" name="school" id="school" value="연세대학교" class="text ui-widget-content ui-corner-all"><br>
						<label for="major">전 공</label><br>
						<input type="text" name="major" id="major" value="전기전자공학부" class="text ui-widget-content ui-corner-all"><br>
						<label for="startdt">입 학</label><br>
						<input type="text" name="startdt" id="startdt" class="text ui-widget-content ui-corner-all"><br>
						<label for="enddt">졸 업</label><br>
			...
			<!-- <div class="contain" class="ui-widget">
				<table id="certi">
					<thead>
						...
						<tr class="ui-widget-header">
							<th>자격(증)명</th><th>성적(등급)</th><th>발행기관</th><th>취득일</th><th>유효기간</th><th>수 정</th><th>삭 제</th>
						</tr>
					</thead>
					<tbody>
						<tr></tr>

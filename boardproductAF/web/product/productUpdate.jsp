...
<h1>상품 수정 - 관리자 페이지</h1>
<form method="post" action="productList.do" enctype="multipart/form-data" name="frm">
			...
			<td>
				<table>
					...
					<tr>
						...
						(주의사항 : 이미지를 변경하고자 할 때 만 선택하시오.)
						</td>
					</tr>
					<tr>
						<th>설  명</th>
						<td><textarea cols="90" rows="10" name="dsc">${product.dsc}</textarea>
						</td>
					</tr>
				</table>
			</td>

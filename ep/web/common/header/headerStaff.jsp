...
<div class="header">
	<div class="hair">
		<div><a href="staff.do?cmd=login&empid=${loginStaff.empid}&pwd=${loginStaff.pwd}">&nbsp;Mars EP</a></div>
		<div class="util">
			<table>
				<tr>
					<td><a href="staff.do?cmd=login&empid=${loginStaff.empid}&pwd=${loginStaff.pwd}">Home</a></td>
					<td><a href="staff.do?cmd=logout">Logout</a></td>
					<td><a href="URL">Admin</a></td>
				</tr>
			</table>
		</div>
	</div>
	<div class="face">
		<div class="logo">
			<a href="staff.do?cmd=login&empid=${loginStaff.empid}&pwd=${loginStaff.pwd}"><img src="images/logo.png" alt="로고 이미지"></a>
		</div>
		<div id="accordion">
			<div>
				<table>

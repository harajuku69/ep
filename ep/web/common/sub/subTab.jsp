			...
			<div id="edu-dialog" title="학력 추가">
				...
				<form>
					<fieldset>
						...
						<input type="text" name="enterdt" id="enterdt" class="text ui-widget-content ui-corner-all"><br>
						<label for="graddt">졸 업</label><br>
						<input type="text" name="graddt" id="graddt" class="text ui-widget-content ui-corner-all"><br>
			...
			<div id="crr-dialog" title="경력 추가">
				...
				<form>
					<fieldset>
						...
						<input type="text" name="outdt" id="outdt" class="text ui-widget-content ui-corner-all"><br>
						<input type="submit" tabindex="-1" style="position:absolute; left:-1000px">
					</fieldset>
				</form>
			</div>

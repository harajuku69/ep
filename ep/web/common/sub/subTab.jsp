			...
			<div id="edu-dialog" title="학력 추가">
				...
				<form id="frm">
					<fieldset>
						...
						<input type="text" name="loc" id="loc" placeholder="인천" class="text ui-widget-content ui-corner-all" required><br>
						<label for="school">학 교</label><br>
						<input type="text" name="school" id="school" placeholder="부평고등학교" class="text ui-widget-content ui-corner-all" required><br>
						<label for="major">전 공</label><br>
						<input type="text" name="major" id="major" placeholder="이과" class="text ui-widget-content ui-corner-all" required><br>
			...
			<div id="crr-dialog" title="경력 추가">
				...
				<form>
					<fieldset>
						...
						<input type="text" name="comnm" id="comnm" placeholder="LG전자" class="text ui-widget-content ui-corner-all" required><br>
						<label for="dpt">근무부서</label><br>
						<input type="text" name="dpt" id="dpt" placeholder="MC사업부" class="text ui-widget-content ui-corner-all" required><br>
						<label for="tit">근무직급</label><br>
						<input type="text" name="tit" id="tit" placeholder="대리" class="text ui-widget-content ui-corner-all" required><br>
			...
			<div id="certi-dialog" title="자격(증) 추가">
				...
				<form>
					<fieldset>
						...
						<input type="text" name="certinm" id="certinm" placeholder="정보처리/TOEIC" class="text ui-widget-content ui-corner-all" required><br>
						<label for="rank">성적(등급)</label><br>
						<input type="text" name="rank" id="rank" placeholder="산업기사/990" class="text ui-widget-content ui-corner-all" required><br>
						<label for="publ">발행기관</label><br>
						<input type="text" name="publ" id="publ" placeholder="한국산업인력공단/ETS" class="text ui-widget-content ui-corner-all" required><br>
